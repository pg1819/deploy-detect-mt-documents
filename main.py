...
from methods.dependency_tree import dependency_tree_feature_extraction, split_into_sentences
from methods.word_embedding import split_into_paragraphs, lemmatise, word_embedding_feature_extraction
from methods.word_distribution import word_distribution_feature_extraction
...
def detect(file, method):
    ...
    if method == "dependency_tree":
        yield 'data: {}\n\n'.format(0)
        model = load_model("trained_models/dt_classifier.pickle")
        ...
        yield 'data: {}\n\n'.format(0)
        model = load_model("trained_models/we_classifier.pickle")
        ...
        yield 'data: {}\n\n'.format(0)
        model = load_model("trained_models/wd_classifier.pickle")
